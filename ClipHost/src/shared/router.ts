...
import CreateStreamerCommandCenter from '../Views/StreamerCommandCenter/CreateStreamerCommandCenter.vue';

let autoroutes = require('./autoroutes.ts')
...
export const routes = [
    {path: Routes.Home, component: CreateStreamerCommandCenter, props: {name: 'Vue'}},
    {path: Routes.About, component: About, props: {message: 'About page'}},
    {path: Routes.SignIn, component: SignIn},
    {path: Routes.SignUp, component: SignUp},
    {path: '/CreateStreamerCommandCenter', component: CreateStreamerCommandCenter},
...
for (const route of Object.keys(autoroutes)) {
    if (route === "default") {
        continue;
    }
    //@ts-ignore
    routes.push(autoroutes[route])
}
